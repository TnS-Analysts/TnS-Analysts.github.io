      ...
      <li><div class="dropdown">
        <div class="options">
          ...
          <div class="more">
            <div class="more-options">
              <span class="text">
                <a href="/pages/Q2/stream_design.html" class="mobile">
                  Stream Design
                </a>
              </span>
          ...
          <div class="more">
            <div class="more-options">
              <span class="text">
                <a href="/pages/Q3/first_stream.html" class="mobile">
                  First Stream
                </a>
              </span>
          ...
          <div class="more">
            <div class="more-options">
              <span class="text">
                <a href="/pages/Q4/second_stream.html" class="mobile">
                  Second Stream
                </a>
              </span>
...
function show(n){
  ...
  for(i = 0; i < line.length; i++){
    line[i].className = line[i].className.replace("active-sl")
  }

  slider[n-1].style.display = ("block")
  line[n-1].className += " active-sl"
}
...
function auto(){
  ...
  show(index)
  setTimeout(auto, 5000) // miliseconds before next image
}
